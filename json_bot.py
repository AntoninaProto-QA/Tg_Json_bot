...
bot = TeleBot(token='6138989821:AAGWb04JgokbToWUk0L_PE46zRYUrRCOoXU', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_photo( 
        ...
        caption='Привет! Я умею проверять JSON и форматировать его в красивый текст\Введи JSON в виде строки:', # текст сообщения
    )
